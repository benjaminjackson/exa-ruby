      ...
      module Imports
        class UpdateTest < Minitest::Test
          ...
          def test_initialize_with_connection_and_id
            service = Update.new(@connection, id: @import_id, title: "Updated Title")
          ...
          def test_call_updates_import_title
            ...
            service = Update.new(@connection, id: @import_id, title: "Updated Import Title")
            result = service.call
          ...
          def test_call_raises_unauthorized_on_401
            ...
            service = Update.new(@connection, id: @import_id, title: "New Title")
          ...
          def test_call_raises_not_found_on_404
            ...
            service = Update.new(@connection, id: "nonexistent", title: "New Title")
