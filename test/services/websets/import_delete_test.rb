...
module Exa
  module Services
    module Websets
      class DeleteImportTest < Minitest::Test
        def setup
        ...
        def test_initialize_with_connection_and_id
          service = DeleteImport.new(@connection, id: @import_id)

          assert_instance_of DeleteImport, service
        end
        ...
        def test_call_raises_not_found_on_404
          ...
          service = DeleteImport.new(@connection, id: "nonexistent")
